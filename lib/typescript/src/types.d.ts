...
export declare enum BluetoothState {
    Unknown = 0,
    Resetting = 1,
    Unsupported = 2,
    Unauthorized = 3,
...
export declare enum LockFunction {
    Passcode = 0,
    IcCard = 1,
    Fingerprint = 2,
    Wristband = 3,
...
export declare enum LockRecordType {
    Latest = 0,
    All = 1
}
export declare enum LockConfigType {
    Audio = 0,
    PasscodeVisible = 1,
    Freeze = 2,
    TamperAlert = 3,
...
export declare enum LockUnlockDirection {
    Unknown = 0,
    Left = 1,
    Right = 2
}
export declare enum LockPassageMode {
    Weekly = 0,
    Monthly = 1
}
export declare enum LockControlType {
    Unlock = 0,
    Lock = 1
}
...
export declare enum FaceState {
    canAddFace = 0,
    addFail = 1
}
export declare enum FaceErrorCode {
    normal = 0,
    noFaceDetected = 1,
    tooCloseToTheTop = 2,
...
export declare enum LockErrorCode {
    hadReset = 0,
    crcError = 1,
    noPermission = 2,
    wrongAdminCode = 3,
...
export declare enum DoorSensorErrorCode {
    bluetoothPowerOff = 0,
    connectTimeout = 1,
    fail = 2,
    wrongCRC = 3
}
export declare enum RemoteKeyErrorCode {
    fail = 0,
    wrongCRC = 1,
    connectTimeout = 2
}
export declare enum RemoteKeyPadErrorCode {
    fail = 0,
    wrongCRC = 1,
    connectTimeout = 2,
    wrongFactoryDate = 3
}
export declare enum GatewayErrorCode {
    fail = 0,
    wrongSSID = 1,
    wrongWifiPassword = 2,
    wrongCRC = 3,
...
export declare enum TTLockEvent {
...
export declare enum TtRemoteKeyEvent {
    ScanRemoteKey = "EventScanRemoteKey"
}
export declare enum TtDoorSensorEvent {
...
export declare enum WirelessKeypadEvent {
...
export declare enum LockAccessoryType {
    KEYPAD = 1,
    REMOTE_KEY = 2,
    DOOR_SENSOR = 3
}
export declare enum GatewayIpSettingType {
    STATIC_IP = 0,
    DHCP = 1
}
export declare enum LiftWorkMode {
