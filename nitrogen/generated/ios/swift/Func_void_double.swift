...
/**
 * Wraps a Swift `(_ state: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.ttlocknitro.bridge.swift

  private let closure: (_ state: Double) -> Void

  public init(_ closure: @escaping (_ state: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(state: Double) -> Void {
    self.closure(state)
  }
