...
/**
 * Wraps a Swift `(_ isOn: Bool) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_bool {
  public typealias bridge = margelo.nitro.ttlocknitro.bridge.swift

  private let closure: (_ isOn: Bool) -> Void

  public init(_ closure: @escaping (_ isOn: Bool) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(isOn: Bool) -> Void {
    self.closure(isOn)
  }
