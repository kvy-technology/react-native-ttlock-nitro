...
/**
 * Wraps a Swift `(_ lockData: String) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_std__string {
  public typealias bridge = margelo.nitro.ttlocknitro.bridge.swift

  private let closure: (_ lockData: String) -> Void

  public init(_ closure: @escaping (_ lockData: String) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(lockData: std.string) -> Void {
    self.closure(String(lockData))
  }
